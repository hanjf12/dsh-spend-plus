...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function formatBalance(view) {
			const n = view === null || view === undefined ? NaN : Number(view.total);
			if (!Number.isFinite(n)) return "—";
			const cur = (view && view.currency) || "CNY";
			const symbol = cur === "CNY" ? "¥" : cur + " ";
			return symbol + n.toLocaleString(void 0, { minimumFractionDigits: 2, maximumFractionDigits: 2 });
		}
...
.mono{font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:11px}
		...
		function UsageStatsWidget({ t, query }) {
			...
			const refresh = react.useCallback(() => {
				setLoading(true);
				fetch("/api/balance").then((r) => r.ok ? r.json() : null).then(setBalance).catch(() => setBalance(null));
				...
				children: [
					showPreview
						? react_jsx_runtime.jsx("div", {
							...
							children: [
								...
								balance?.total !== undefined ? react_jsx_runtime.jsx("div", { className: "dsu-popItem", children: [react_jsx_runtime.jsx("span", { className: "dsu-popLabel", children: t("summary.balance") }), react_jsx_runtime.jsx("span", { className: "dsu-popValue", children: formatBalance(balance) })] }) : null,											],
										}),
								react_jsx_runtime.jsx("div", {
					...
					react_jsx_runtime.jsx("button", {
						...
						children: [
							...
							balance?.total !== undefined ? react_jsx_runtime.jsx("span", { className: "dsu-pillTokens", children: `· ${t("summary.balance")} ${formatBalance(balance)}` }) : null,
